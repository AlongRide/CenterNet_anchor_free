...
def file_name(file_dir):   
    ...
    return L  
image_sets=file_name('/home/ting/tensorflow/Driving/train_dataset/train_image/');#图片存贮路径
#色调增强
...
def creat_dataset(image_num = 30000, mode = 'original'):
    ...
    for i in tqdm(range(len(image_sets))):
        count = 0
        src_img = TIFF.open('/home/ting/tensorflow/Driving/val/image/' + image_sets[i])  # 4 channels
        src_img = src_img.read_image()
        label_img = TIFF.open('/home/ting/tensorflow/Driving/val/label/' + image_sets[i]) # 4 channels
        ...
        while count < image_each:
            ...
            scipy.misc.imsave('/home/ting/tensorflow/Driving/train_dataset/aug_train_image/%d.tif' % g_count,src_roi)
            scipy.misc.imsave('/home/ting/tensorflow/Driving/train_dataset/aug_seg_label/%d.tif' % g_count,label_roi)
            count += 1 
            g_count += 1
            print(count)
